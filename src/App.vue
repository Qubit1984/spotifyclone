            ...
            <button @click="openMenu = !openMenu" :class="openMenu ? 'bg-[#282828]' : 'bg-black'"
                ...
                <div class="flex items-center">
                    <img 
                      class="rounded-full" 
                      width="27"
                      src="https://yt3.ggpht.com/yZ0k4Z9u144GUMohOzPVGFl3PCWBhPvdhKI_HvDcb_giFHb1RVmb0gK8nO4QDOIf9CL6dcnPaw=s88-c-k-c0x00ffffff-no-rj"
                    >
                    <div class="text-white text-[14px] ml-1.5 font-semibold">Bright</div>
